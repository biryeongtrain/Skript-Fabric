...
- function runtime now closes dynamic validation-cache discrimination and script-local-before-global registry lookup, but broader namespace/default-parameter parity is still incomplete
