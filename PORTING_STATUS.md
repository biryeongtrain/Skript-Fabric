...
- latest closed core slice: worker-merged `lang-core` parity for transitive parser priorities, omitted optional-choice defaults, one-based plural script param indices, parser-data script-swap callbacks, and retained statement diagnostics
