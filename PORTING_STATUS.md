...
- latest closed core slice: worker-merged `lang-core` parity for clone fallback, raw-input keyword prefiltering, trigger throwable handling, and skipped-node validation
