...
- latest closed core slice: worker-merged `lang-core` parity for exact parser lookup, tagged-branch suffix omitted-default enforcement, tracked-script dynamic references, parser section helpers, and retained parse-error ties
