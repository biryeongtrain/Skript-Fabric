...
- latest closed core slice: worker-merged `lang-core` parity for converter-context parsing, validatePattern compatibility, primitive-array consign semantics, and parser-data event notifications
