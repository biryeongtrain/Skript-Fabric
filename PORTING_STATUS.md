...
- latest closed core slice: worker-merged loader/parser/runtime/function parity for stale section errors, exact omitted defaults, trigger fail-closed overflow handling, and direct null function slots
