...
- latest closed core slice: worker-merged classes/loader/parser/runtime/function parity for classinfo cloners, doubled-quote function literals, keyed argument metadata, statement-mode effect-section fallback, legacy parser stringification, stale section errors, exact omitted defaults, trigger fail-closed overflow handling, and direct null function slots
