...
- latest closed core slice: worker-merged `lang-core` parity for specific parser precedence, explicit input-parser binding, and config-only loader-node skipping
