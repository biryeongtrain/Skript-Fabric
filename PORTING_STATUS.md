...
- latest closed core slice: worker-merged classes/loader/parser/runtime/function parity for legacy parser stringification, stale section errors, exact omitted defaults, trigger fail-closed overflow handling, and direct null function slots
