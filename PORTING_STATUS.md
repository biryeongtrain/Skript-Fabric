...
- latest closed core slice: worker-merged `lang-core` parity for empty option-value handling, lazy global-function binding, same-script parser-hint preservation, and whitespace-only loader diagnostics
