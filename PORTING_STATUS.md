...
- latest closed core slice: worker-merged `lang-core` parity for ordered superclass-info lookup, exact matched-branch omitted-default activation, function-registry cleanup on script unload, and the `ExprInput#getSpecifiedType()` bridge
