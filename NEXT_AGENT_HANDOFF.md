...
- latest closed slice is `lang` core closure for dynamic-function validation caching, recursive `Classes.clone(...)` array isolation, and `SkriptParser.ParseResult.source`
