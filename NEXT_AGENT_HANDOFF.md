...
- latest closed slice is worker-merged `lang-core` closure for parser-first primitive parsing, omitted optional-branch defaults, and parser-data registration guard
