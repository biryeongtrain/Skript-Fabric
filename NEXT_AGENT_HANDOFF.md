...
- latest closed slice is worker-merged `lang-core` closure for classinfo cloners, doubled-quote function literals, keyed argument metadata, keyed-default plural compatibility, statement-mode effect-section fallback, legacy parser stringification, loader fallback errors, exact omitted-default typing, trigger fail-closed overflow handling, and direct null function arguments surviving the legacy execute-with-nulls guard
