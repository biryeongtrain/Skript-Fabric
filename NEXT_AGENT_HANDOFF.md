...
- latest closed slice is worker-merged `lang-core` closure for ordered superclass-info lookup, exact matched-branch omitted-default activation, function-registry cleanup on script unload, and the `ExprInput#getSpecifiedType()` bridge
