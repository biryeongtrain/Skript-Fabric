...
- latest closed slice is worker-merged `lang-core` closure for empty-array `Classes.toString(...)`, exact parser default type matching, and `TriggerItem.walk(...)` exception handling
