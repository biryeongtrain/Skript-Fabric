...
- latest closed slice is worker-merged `lang-core` closure for specific parser precedence, explicit input-parser binding, and config-only loader-node skipping
