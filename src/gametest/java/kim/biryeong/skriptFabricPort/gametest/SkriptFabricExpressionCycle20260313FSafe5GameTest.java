...
public final class SkriptFabricExpressionCycle20260313FSafe5GameTest extends AbstractSkriptFabricGameTestSupport {
    ...
    public void safe5ItemExpressionsExecuteRealScript(GameTestHelper helper) {
        ...
        runWithRuntimeLock(helper, () -> {
            ...
            runtime.loadFromResource("skript/gametest/expression/cycle-20260313f-safe5/item_expressions_execute.sk");

            int executed = dispatch(runtime, helper, new Safe5ItemContextHandle());
            helper.assertTrue(
                    executed == 1,
            ...
            assertNumber(helper, "safe5::level_before", 2.0D);
            assertNumber(helper, "safe5::level_after", 3.0D);
            helper.assertTrue(
                    Variables.getVariable("safe5::type", null, false) instanceof FabricItemType type
                            && type.item() == Items.DIAMOND_SWORD,
                    Component.literal("Expected type of lane-safe5-itemstack to resolve to a diamond sword item type.")
            );
            helper.assertTrue(
                    Variables.getVariable("safe5::owner_before", null, false) instanceof GameProfile ownerBefore
                            && startingOwner.equals(ownerBefore),
                    Component.literal("Expected skull owner getter to expose the original owner profile.")
            );
            helper.assertTrue(
                    Variables.getVariable("safe5::owner_after", null, false) instanceof GameProfile ownerAfter
                            && nextOwner != null
    ...
    public void safe5MeExpressionExecutesThroughRealCommandEvent(GameTestHelper helper) {
        runWithRuntimeLock(helper, () -> {
            SkriptRuntime runtime = SkriptRuntime.instance();
            runtime.clearScripts();
            runtime.loadFromResource("skript/gametest/expression/cycle-20260313f-safe5/me_executes_in_command_event.sk");
    ...
    private static void ensureSupportRegistered() {
        ...
        Skript.registerEvent(GameTestSafe5ItemContextEvent.class, "gametest cycle 20260313f safe5 item context");
        Skript.registerExpression(Safe5ItemExpression.class, FabricItemType.class, "lane-safe5-item");
        Skript.registerExpression(Safe5ItemStackExpression.class, ItemStack.class, "lane-safe5-itemstack");
        Skript.registerExpression(Safe5SkullItemExpression.class, FabricItemType.class, "lane-safe5-skull-item");
        Skript.registerExpression(Safe5EnchantmentExpression.class, Enchantment.class, "lane-safe5-enchantment");
        Skript.registerExpression(Safe5SecondEnchantmentExpression.class, Enchantment.class, "lane-safe5-second-enchantment");
        Skript.registerExpression(Safe5NextOwnerExpression.class, GameProfile.class, "lane-safe5-next-owner");
    }
    ...
    private record Safe5ItemContextHandle() {
    }

    public static final class GameTestSafe5ItemContextEvent extends ch.njol.skript.lang.SkriptEvent {
        @Override
        ...
        public boolean check(SkriptEvent event) {
            return event.handle() instanceof Safe5ItemContextHandle;
        }

        @Override
        public Class<?>[] getEventClasses() {
            return new Class<?>[]{Safe5ItemContextHandle.class};
        }

        @Override
        public String toString(@Nullable SkriptEvent event, boolean debug) {
            return "gametest cycle 20260313f safe5 item context";
        }
    }

    public static final class Safe5ItemExpression extends SimpleExpression<FabricItemType> {
        @Override
    ...
    public static final class Safe5ItemStackExpression extends SimpleExpression<ItemStack> {
        @Override
    ...
    public static final class Safe5SkullItemExpression extends SimpleExpression<FabricItemType> {
        @Override
        protected FabricItemType @Nullable [] get(SkriptEvent event) {
    ...
    public static final class Safe5EnchantmentExpression extends SimpleExpression<Enchantment> {
        @Override
    ...
    public static final class Safe5SecondEnchantmentExpression extends SimpleExpression<Enchantment> {
        @Override
        protected Enchantment @Nullable [] get(SkriptEvent event) {
    ...
    public static final class Safe5NextOwnerExpression extends SimpleExpression<GameProfile> {
        @Override
