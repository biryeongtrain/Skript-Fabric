...
public final class SkriptFabricExpressionBellAndSolidBlockGameTest extends AbstractSkriptFabricGameTestSupport {
    ...
    public void ringingTimeExpressionExecutesRealScript(GameTestHelper helper) {
        ...
        runWithRuntimeLock(helper, () -> {
            ...
            runtime.loadFromResource("skript/gametest/expression/bell-and-solid-block/ringing_time_marks_block.sk");
            ...
            int executed = dispatch(runtime, helper, new BellAndSolidBlockHandle(helper.getLevel(), bellPos));
            assertExecuted(helper, executed, "bell and solid block ringing time");
    ...
    public void resonatingTimeExpressionExecutesRealScript(GameTestHelper helper) {
        ...
        runWithRuntimeLock(helper, () -> {
            SkriptRuntime runtime = SkriptRuntime.instance();
            runtime.clearScripts();
            runtime.loadFromResource("skript/gametest/expression/bell-and-solid-block/resonating_time_marks_block.sk");
            ...
            int executed = dispatch(runtime, helper, new BellAndSolidBlockHandle(helper.getLevel(), bellPos));
            assertExecuted(helper, executed, "bell and solid block resonating time");
    ...
    public void lowestHighestSolidBlockExpressionExecutesRealScript(GameTestHelper helper) {
        ...
        runWithRuntimeLock(helper, () -> {
            SkriptRuntime runtime = SkriptRuntime.instance();
            runtime.clearScripts();
            runtime.loadFromResource("skript/gametest/expression/bell-and-solid-block/lowest_highest_solid_block_marks_blocks.sk");
            ...
            int executed = dispatch(runtime, helper, new BellAndSolidBlockHandle(helper.getLevel(), column));
            assertExecuted(helper, executed, "bell and solid block");
            ...
            Variables.setVariable("bellblock::origin", null, SkriptEvent.EMPTY, false);
            runtime.clearScripts();
        });
    }
    ...
    private static void ensureSupportRegistered() {
        ...
        Skript.registerEvent(GameTestBellAndSolidBlockEvent.class, "gametest bell and solid block context");
    }
    ...
    private record BellAndSolidBlockHandle(net.minecraft.server.level.ServerLevel level, BlockPos position) implements FabricBlockEventHandle {
    }

    public static final class GameTestBellAndSolidBlockEvent extends ch.njol.skript.lang.SkriptEvent {
        @Override
        ...
        public boolean check(SkriptEvent event) {
            return event.handle() instanceof BellAndSolidBlockHandle;
        }

        @Override
        public Class<?>[] getEventClasses() {
            return new Class<?>[]{BellAndSolidBlockHandle.class};
        }

        @Override
        public String toString(@Nullable SkriptEvent event, boolean debug) {
            return "gametest bell and solid block context";
        }
    }
}
