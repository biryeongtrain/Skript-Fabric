...
public final class SkriptFabricExpressionCycleJSyntax1GameTest extends AbstractSkriptFabricGameTestSupport {
    ...
    public void appliedEffectExpressionExecutesRealScript(GameTestHelper helper) {
        ...
        runWithRuntimeLock(helper, () -> {
            ...
            runtime.loadFromResource("skript/gametest/expression/cycle-j/syntax1/applied_effect_marks_block.sk");
    ...
    public void nearestEntityExpressionExecutesRealScript(GameTestHelper helper) {
        ...
        runWithRuntimeLock(helper, () -> {
            SkriptRuntime runtime = SkriptRuntime.instance();
            runtime.clearScripts();
            runtime.loadFromResource("skript/gametest/expression/cycle-j/syntax1/nearest_entity_names_closest_cow.sk");
            ...
            int executed = dispatch(runtime, helper, new CycleJSyntax1Handle());
            ...
            Variables.setVariable("cyclej::syntax1::origin", null, SkriptEvent.EMPTY, false);
            runtime.clearScripts();
        });
    }
    ...
    public void targetedBlockExpressionExecutesRealScript(GameTestHelper helper) {
        ...
        runWithRuntimeLock(helper, () -> {
            SkriptRuntime runtime = SkriptRuntime.instance();
            runtime.clearScripts();
            runtime.loadFromResource("skript/gametest/expression/cycle-j/syntax1/targeted_block_marks_above.sk");
            ...
            int executed = dispatch(runtime, helper, new CycleJSyntax1Handle(), player);
    ...
    public static final class GameTestCycleJSyntax1Event extends ch.njol.skript.lang.SkriptEvent {
