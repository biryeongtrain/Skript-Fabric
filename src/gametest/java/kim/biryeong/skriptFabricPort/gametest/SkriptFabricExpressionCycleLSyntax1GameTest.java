...
public final class SkriptFabricExpressionCycleLSyntax1GameTest extends AbstractSkriptFabricGameTestSupport {
    ...
    public void projectileForceExpressionExecutesRealScript(GameTestHelper helper) {
        runWithRuntimeLock(helper, () -> {
            ...
            Variables.clearAll();
            runtime.loadFromResource("skript/gametest/expression/cycle-l/syntax1/projectile_force_marks_block.sk");
            ...
            assertNumberAtLeast(helper, "cyclel::syntax1::projectile_force", 0.01D);
            runtime.clearScripts();
            Variables.clearAll();
        });
    }
