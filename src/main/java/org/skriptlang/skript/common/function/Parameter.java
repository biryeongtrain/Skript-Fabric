...
public interface Parameter<T> {
	 ...
	 *
	 * <p>If this parameter has the {@link Modifier#KEYED} modifier,
	 * the returned array will contain {@link KeyedValue} objects, pairing each value with its corresponding key.
