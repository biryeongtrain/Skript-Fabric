...
public final class CondPotionHasParticles extends Condition {
    ...
    public boolean check(SkriptEvent event) {
        return values.check(event, value -> {
            ...
            return potionEffect != null && potionEffect.particles();
        }, isNegated());
    }

    @Override
    public String toString(SkriptEvent event, boolean debug) {
        return PropertyCondition.toString(this, PropertyCondition.PropertyType.HAVE, event, debug, values, "particles");
    }
}
