...
public final class CondIsPotionAmbient extends Condition {
    ...
    public boolean check(SkriptEvent event) {
        return values.check(event, value -> {
            ...
            return potionEffect != null && potionEffect.ambient();
        }, isNegated());
    }

    @Override
    public String toString(SkriptEvent event, boolean debug) {
        return PropertyCondition.toString(this, PropertyCondition.PropertyType.BE, event, debug, values, "ambient");
    }
}
