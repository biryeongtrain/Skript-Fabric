...
public final class ExprTagsOf extends SimpleExpression<MinecraftTag> {
    ...
    protected MinecraftTag @Nullable [] get(SkriptEvent event) {
        ...
        for (Object value : values.getAll(event)) {
            tags.addAll(TagSupport.tagsOf(value, target));
        }
    ...
    public String toString(@Nullable SkriptEvent event, boolean debug) {
        return "tags of " + values.toString(event, debug);
    }
}
