...
public final class ExprEquipCompEquipSound extends SimpleExpression<String> {
    ...
    protected String @Nullable [] get(SkriptEvent event) {
        return values.stream(event)
                ...
                .map(EquippableWrapper::equipSound)
    ...
    public String toString(@Nullable SkriptEvent event, boolean debug) {
        return "equip sound of " + values.toString(event, debug);
    }
}
