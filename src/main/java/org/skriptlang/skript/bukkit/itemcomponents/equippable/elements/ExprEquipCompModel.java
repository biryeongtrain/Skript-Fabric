...
public final class ExprEquipCompModel extends SimpleExpression<String> {
    ...
    public String toString(@Nullable SkriptEvent event, boolean debug) {
        return "equipped model id of " + values.toString(event, debug);
    }
}
