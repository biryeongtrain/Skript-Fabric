...
public class ExprRepeat extends SimpleExpression<String> {
    ...
    static {
        Skript.registerExpression(ExprRepeat.class, String.class, "%strings% repeated %integer% time[s]");
    }
    ...
    protected @Nullable String[] get(SkriptEvent event) {
        ...
        return strings.stream(event)
                .map(string -> StringUtils.multiply(string, repeatCount))
                .toArray(String[]::new);
    }
