...
public class ReturnableTrigger<T> extends Trigger implements ReturnHandler<T> {
    ...
    public ReturnableTrigger(
            ReturnHandler<T> handler,
            @Nullable Script script,
            String name,
            ch.njol.skript.lang.SkriptEvent event,
            Function<ReturnHandler<T>, List<TriggerItem>> loadItems
    ) {
    ...
    @Override
    public void returnValues(org.skriptlang.skript.lang.event.SkriptEvent event, Expression<? extends T> value) {
